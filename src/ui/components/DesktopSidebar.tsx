        ...
        <div className="hidden lg:flex flex-col gap-3 w-64 h-full p-4">
            ...
            <div className="bg-[#f5f5f5] rounded-xl border border-gray-200/60 overflow-hidden">
                ...
                <div className="p-4 pt-2 text-center">
                    <h3 className="font-semibold text-gray-700">Moussandou</h3>
                    ...
                    <div className="flex justify-center gap-1.5 mt-3">
                        <a href="https://github.com/Moussandou" target="_blank" rel="noopener noreferrer"
                            className="w-8 h-8 bg-white rounded-lg border border-gray-200/60 flex items-center justify-center hover:bg-gray-50 transition-colors">
            ...
            <div className="bg-[#f5f5f5] rounded-xl p-4 border border-gray-200/60 flex-1">
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="text-xs font-mono text-gray-600 bg-white px-2 py-0.5 rounded border border-gray-200/60">1.0.0</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-xs text-gray-500">Games</span>
                        <span className="text-xs font-mono text-gray-600 bg-white px-2 py-0.5 rounded border border-gray-200/60">{APP_REGISTRY.filter(a => !['settings', 'clock', 'credits'].includes(a.id)).length}</span>
                    </div>
                    <div className="flex justify-between items-center">
                        <span className="text-xs text-gray-500">Platform</span>
                        <span className="text-xs font-mono text-gray-600 bg-white px-2 py-0.5 rounded border border-gray-200/60">Web</span>
                    </div>
                </div>
            </div>
        </div>
