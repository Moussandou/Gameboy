...
export const CreditsApp: React.FC<{ input?: Set<string> }> = () => {
    return (
        <div className="w-full h-full bg-[#eeeeee] flex flex-col font-jersey text-gb-screen-darkest relative overflow-hidden">
            {/* Header */}
            <div className="h-8 bg-white border-b border-gray-300 flex items-center justify-center shadow-sm z-10 shrink-0">
                <span className="text-sm text-gray-600 font-bold tracking-widest">CREDITS</span>
            </div>

            <div className="flex-1 flex flex-col items-center justify-center p-2 text-center">
                {/* Logo + Title inline */}
                <div className="flex items-center gap-2 mb-2">
                    <div className="w-10 h-10 bg-white border-2 border-[#555] rounded-lg flex items-center justify-center shadow">
                        <div className="grid grid-cols-2 gap-0.5 p-1">
                            <div className="w-2 h-2 bg-[#555] rounded-[1px]"></div>
                            <div className="w-2 h-2 bg-[#555] rounded-[1px]"></div>
                            <div className="w-2 h-2 bg-[#555] rounded-[1px]"></div>
                            <div className="w-2 h-2 bg-[#555] rounded-[1px]"></div>
                        </div>
                    ...
                    <div className="text-left">
                        <h1 className="text-sm text-[#333] font-bold tracking-wider leading-tight">MOUSSANDOU OS</h1>
                        <p className="text-[9px] text-gray-500">GameBoy SP Emulator</p>
                    </div>
                </div>

                {/* Credits */}
                <div className="bg-white rounded-lg py-2 px-4 shadow border border-gray-200 mb-2">
                ...
                <div className="flex gap-2">
                    <a href="https://github.com/Moussandou" target="_blank" rel="noopener noreferrer"
                        className="w-7 h-7 bg-white rounded-lg border border-gray-200 shadow-sm flex items-center justify-center">
