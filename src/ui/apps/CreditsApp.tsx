            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                ...
                <div className="mt-4 flex gap-3">
                    <a
                        ...
                        className="w-10 h-10 bg-white rounded-xl border border-gray-200 shadow-sm flex items-center justify-center hover:bg-gray-50 transition-colors"
                    >
                    ...
                    <a
                        ...
                        className="w-10 h-10 bg-white rounded-xl border border-gray-200 shadow-sm flex items-center justify-center hover:bg-gray-50 transition-colors"
                    >
                        <svg className="w-5 h-5 text-[#5acbf7]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
