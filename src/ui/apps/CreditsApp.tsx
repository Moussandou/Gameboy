    ...
    return (
        <div className="w-full h-full bg-[#eeeeee] flex flex-col font-jersey text-gb-screen-darkest relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-3 text-center overflow-y-auto">
                {/* Logo */}
                <div className="w-14 h-14 bg-white border-3 border-[#555] rounded-xl flex items-center justify-center shadow-lg mb-3 shrink-0">
                    <div className="grid grid-cols-2 gap-1 p-2">
                        <div className="w-3 h-3 bg-[#555] rounded-[2px]"></div>
                        <div className="w-3 h-3 bg-[#555] rounded-[2px]"></div>
                        <div className="w-3 h-3 bg-[#555] rounded-[2px]"></div>
                        <div className="w-3 h-3 bg-[#555] rounded-[2px]"></div>
                    </div>
                ...
                {/* Title */}
                <h1 className="text-lg text-[#333] font-bold tracking-widest mb-1">
                    MOUSSANDOU OS
                </h1>
                <p className="text-xs text-gray-500 mb-4">GameBoy Advance SP Emulator</p>

                {/* Credits */}
                <div className="bg-white rounded-lg p-3 shadow-md border border-gray-200 w-full max-w-[180px] shrink-0">
                    <p className="text-gray-400 text-[10px] uppercase tracking-wider mb-1">Created by</p>
                    <p className="text-[#5acbf7] font-bold text-base">Moussandou</p>
                </div>
                ...
                <div className="mt-3 flex gap-2 shrink-0">
                    <a
                        ...
                        className="w-8 h-8 bg-white rounded-lg border border-gray-200 shadow-sm flex items-center justify-center"
                    >
                    ...
                    <a
                        href="https://moussandou.github.io/Portfolio/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-8 h-8 bg-white rounded-lg border border-gray-200 shadow-sm flex items-center justify-center"
                    >
                ...
                {/* Version */}
                <div className="mt-3 text-gray-400 text-[10px] shrink-0">
                    <p>Version 1.0.0</p>
