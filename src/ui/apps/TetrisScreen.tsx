    ...
    return (
        <div className={`w-full h-full ${bgClass} flex flex-col items-center justify-center font-jersey relative overflow-hidden transition-colors duration-300`}>
            ...
            {!isPlaying && !gameOver ? (
                ...
                <div className={`relative border-4 ${isDark ? 'border-[#444] bg-[#222]' : 'border-gray-400 bg-white'} rounded p-1 shadow-inner z-10 -mt-10`} style={{ width: '60%', aspectRatio: `${COLS}/${ROWS}` }}>
